...
<head>
  ...
  <script src="/BSCHI/html/assets/plugins/rateit/src/jquery.rateit.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        .config(function ($routeProvider) {
            $routeProvider.
                ...
                when('user/account-info', {
                    templateUrl: 'html/account-info.html',
                    controller: 'b_Controller'
                }).
                when('user/product-page', {
        ...
        mainapp.controller('commentItemController', function ($scope, $http, BschiHttpService) {
          ...
          $scope.username = "Bob";
          $scope.datetime = new Date().toUTCString();
          console.log($scope);
        });
        ...
        mainapp.directive('shopItem', function () {
            return {
              restrict: 'EA',
              templateUrl: 'html/shop-item.html',
              controller: 'shopItemController'
            };
        });

        mainapp.controller('shopItemController', function ($scope, $http, BschiHttpService) {

        });

        mainapp.directive('star', function () {
            return {
